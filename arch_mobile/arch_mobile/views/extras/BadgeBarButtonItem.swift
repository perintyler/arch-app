...
//  arch_mobile
//
//  Created by Reilly Freret on 10/24/18.
...
//        let button = UIButton(type: .custom)
        ...
        let i = image.withRenderingMode(.alwaysTemplate)
        button.setBackgroundImage(i, for: .normal)
        button.tintColor = UIColor.Theme.teal
